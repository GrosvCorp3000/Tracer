 ...
 */
class G6Weap_Laser extends UTBeamWeapon;
...
var array<G6Weap_Laser> LinkedList;	// I made a funny Hahahahah :)
...
var class<G6Attachment_Laser> LinkAttachmentClass;
...
simulated function PostBeginPlay()
{
	...
	LinkAttachmentClass = class<G6Attachment_Laser>(AttachmentClass);
...
function GetLinkedWeapons(out array<G6Weap_Laser> LinkedWeapons)
{
	local int i;
...
{
	local array<G6Weap_Laser> LinkedWeapons;
...
defaultproperties
{
	...
	AttachmentClass=class'G6Attachment_Laser'
