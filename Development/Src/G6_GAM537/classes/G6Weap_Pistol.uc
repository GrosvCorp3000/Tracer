 ...
 */
class G6Weap_Pistol extends UTBeamWeapon;
...
var array<G6Weap_Pistol> LinkedList;	// I made a funny Hahahahah :)
...
function GetLinkedWeapons(out array<G6Weap_Pistol> LinkedWeapons)
{
	local int i;
...
{
	local array<G6Weap_Pistol> LinkedWeapons;
...
defaultproperties
{
	...
	Begin Object Name=FirstPersonMesh
		...
		AnimSets(0)=AnimSet'WP_ShockRifle.Anim.K_WP_ShockRifle_3P_Base'
